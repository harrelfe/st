...
Lower confidence limits for BCa and the percentile bootstrap are almost indistinguishable, especially for $n > 200$.  Upper limits converge around $n=150$.  This informs the default for the `Hmisc` `pMedian` function: BCa for $n < 150$ and percentile otherwise.

...
## Discussion Archive (2020)

**Ali**: Fascinating read once again, and a very timely one. Thanks!
The total disregard of "prior" information in designing clinical trials is indeed astounding to me. A very good example (in my humble opinion) of the proposed design has recently been done in a [comparative study of proton vs. photon radiation treatment of Esophageal cancer](https://ascopubs.org/doi/full/10.1200/JCO.19.02503).

**Frank Harrell**: Neat. It's just that with a Bayesian sequential design there is no need to create time intervals. Analysis time can be completely flexible.

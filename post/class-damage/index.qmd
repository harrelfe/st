...
date: 2017-03-01
modified: 2022-09-18
categories: [prediction, machine-learning, accuracy-score, dichotomization, probability, bioinformatics, validation, classification, data-science, 2017]
description: "Estimating tendencies is usually a more appropriate goal than classification, and classification leads to the use of discontinuous accuracy scores which give rise to misleading results."
---

I [have discussed](../classification) the many advantages of probability estimation over classification.  Here I discuss a particular problem related to
classification, namely the harm done by using discontinuous accuracy scoring
...
non-event and Y=1 the event occurred. [[Comments](https://hbiostat.org/comment.html)]{.aside}


As discussed [here](https://en.wikipedia.org/wiki/Scoring_rule) and [here](https://webfiles.uci.edu/msteyver/publications/MerkleSteyvers.pdf),
...
measure, i.e., mean squared error or [Brier score](https://en.wikipedia.org/wiki/Brier_score), and the logarithmic
...
accuracy is also not a strictly proper scoring rule.  It can be optimized by
...
in [Biostatistics for Biomedical Research](https://hbiostat.org/bbr/info.html) Chapter 18 in which 
...
The use of a discontinuous accuracy score such as proportion
...
0.98 whereas their extensive data analysis yielded an accuracy of 0.97.
 As discusssed [here](../classification ),
...
classification accuracy.  As such they are also discontinuous 
...
* [The harm of class imbalance corrections for risk prediction models: illustration and simulation using logistic regression](https://academic.oup.com/jamia/article/29/9/1525/6605096) by van den Goorbergh, van Smeden, Timmerman, Van Calster


## [Archived Discussions](disqus.pdf)

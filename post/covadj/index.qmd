...
author:
  - name: Ewout Steyerberg<br><small>`@ESteyerberg`</small>
...
date: 2020-07-19
categories: [2020, drug-evaluation, generalizability, medicine, personalized-medicine, prediction, RCT, regression]
description: 'This article summarizes arguments for the claim that the primary analysis of treatment effect in a RCT should be with adjustment for baseline covariates.  It reiterates some findings and statements from classic papers, with illustration on the GUSTO-I trial.'
---

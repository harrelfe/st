...
date: 2019-04-08
modified: 2019-12-25
categories: [RCT, generalizability, medicine, metrics, personalized-medicine, subgroup, 2019]
description: "Reasons are given for why heterogeneity of treatment effect must be demonstrated, not assumed.  An example is presented that shows that HTE must exceed a certain level before personalizing treatment results in better decisions than using the average treatment effect for everyone."
---
...
* in a more restricted sense demonstrating an interaction between treatment and patient characteristics on a scale for which it is possible that such interaction may be absent even if the main effect for treatment is nonzero.  [[Comments](https://hbiostat.org/comment.html)]{.aside}
...
[This](../varyor) article provided a real clinical trial example where HTE was formally tested and quantified.  The purpose of the present article is to demonstrate point 3. above.

...
author:
  - name: Frank Harrell
    ...
    affiliation: Professor of Biostatistics<br>Vanderbilt University School of Medicine
  - name: Laura Lazzeroni
    affiliation: Professor of Psychiatry and, by courtesy, of Medicine (Cardiovascular Medicine) and of Biomedical Data Science<br>Stanford University School of Medicine
date: 2017-06-01
modified: 2023-02-21
categories: [prediction, generalizability, drug-evaluation, evidence, subgroup, EHR, design, medicine, inference, big-data, RCT, personalized-medicine, 2017]
description: "Observational data from electronic health records may contain biases that large sample sizes do not overcome.  Moderate confounding by indication may render an infinitely large observational study less useful than a small randomized trial for estimating relative treatment effectiveness."
---
...
the result is a bias called *confounding by indication*. [[Comments](https://hbiostat.org/comment.html)]{.aside}
...
data frequently teach us things that are [just plain wrong](https://www.youtube.com/watch?v=TGGGDpb04Yc). This is due to a
...
-   Obtain the best covariate-adjusted estimate of relative treatment
    ...
    *[Biostatistics for Biomedical Research](https://hbiostat.org/bbr/ancova.html)*.
...
* [The magic of randomization versus the myth of real-world evidence](https://www.nejm.org/doi/full/10.1056/NEJMsb1901642) by Collins _et al_
* [Unrepresentative big surveys significantly overestimated US vaccine update](https://www.nature.com/articles/s41586-021-04198-4) by VC Bradley _et al_.  "We show how a survey of 250,000 respondents can produce an estimate of the population mean that is no more accurate than an estimate from a simple random sample of size 10."  Paper includes discussion of bias-corrected effective sample size.
   * [The big data paradox in cliniical practice](https://www.tandfonline.com/doi/full/10.1080/07357907.2022.2084621?fbclid=IwAR18reY64uCwXvlQ3bJYb-1Fve_k5WZAZtDU-OEwaEciE13RPoDR3WnWvdY&mibextid=uc01c0) by Pavlos Msaouel

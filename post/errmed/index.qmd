...
date: 2017-04-08
modified: 2021-08-02
categories: [prediction, logic, p-value, validation, bayes, evidence, subgroup, dichotomization, medicine, inference, change-scores, RCT, personalized-medicine, responder-analysis, hypothesis-testing, medical-literature, 2017]
description: "This article catalogs several types of statistical problems that occur frequently in the medical journal articles."
---
...
As Doug Altman famously wrote in his _[Scandal of Poor Medical Research](http://www.bmj.com/content/308/6924/283)_ in BMJ in 1994, the
...
the literature. [[Comments](https://hbiostat.org/comment.html)]{.aside}
...
detailed [here](../pval-litany) and [here](https://datamethods.org/t/language-for-communicating-frequentist-results-about-treatment-effects),
...
[here](https://hbiostat.org/bbr/change.html), and
...
2.  Add to this model a tensor spline in the baseline and 6m T levels,
    ...
    be smooth. See for example [this plot](http://hbiostat.org/bbr/descript.html#fig-descript-image-stroke). One can do this by
...
treatment effect (AKA *precision medicine*) may be found [here](http://hbiostat.org/bbr/ancova.html). To make matters

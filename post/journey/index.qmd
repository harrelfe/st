...
|  |  |
|  |  <small>Any disagreements between two observers on the posterior probabilities coming from their use of different priors pales in comparison to disagreements about what to do after computing a data probability computed conditional on an unobservable.</small> |
|  |  |
...
|  |  |
|  | <small>You cannot call something an error by assuming the very fact that would make it one.</small> |
|  |  |

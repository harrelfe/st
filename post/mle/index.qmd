...
tim(orm    = orm.fit(x, y, eps=1e-9,           compstats=FALSE),
...
* [Video by Richard McElreath](https://youtu.be/mt9WKbQJrI4?si=QxpMoj7xfi7flt5x) explaining numerical accuracy issues in log likelihood calculations.
* [R CRAN Task Views](https://cran.r-project.org/web/views/Optimization.html) on optimizers
* [Calculating OLS regression coefficients](https://thomvolker.github.io/blog/2506_regression) by TB Volker, which contains excellent background information about matrix algebra and timing and memory usage of various algorithms in R
...
* [A cornucopia of maximum likelihood algorithms](https://doi.org/10.1080/00031305.2025.2526535) by K Lange, XJ Li, Hua Zhou, 2025.

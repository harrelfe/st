...
date: 2017-11-21
modified: 2017-11-26
categories: [variability, data-reduction, 2017]
description: "This article addresses data reduction, also called unsupervised learning."
---
...
purposes: [[Comments](https://hbiostat.org/comment.html)]{.aside}
...
measures of dispersion.  I'm glad you mentioned [Gini's mean difference](https://arxiv.org/pdf/1405.5027.pdf), which is the mean of
...
example of this is in Section 4.7.3 of [RMS](https://hbiostat.org/rms).

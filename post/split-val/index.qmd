...
date: 2017-01-23
modified: 2020-11-15
categories: [prediction, bootstrap, validation, 2017]
author:
  - name: Frank Harrell
    url: https://hbiostat.org
    affiliation: Vanderbilt University<br>School of Medicine<br>Department of Biostatistics
description: "The many disadvantages of split-sample validation, including subtle ones, are discussed."
---
...
10-fold cross-validation are required.  [[Comments](https://hbiostat.org/comment.html)]{.aside}

As discussed in more detail in Section 5.3 of [Regression Modeling Strategies Course Notes](http://hbiostat.org/rmsc) and the
...
larger sample size than resampling to work acceptably well.  See also [here](https://hbiostat.org/bbr/reg.html#internal-vs.-external-model-validation).
...
for example the section *Studies of Methods Used in the Text* [here](http://hbiostat.org/rms).  As shown in a
...
* How to choose between [internal and external validation](https://hbiostat.org/bbr/reg.html#summary-choosing-internal-vs.-external-validation)
